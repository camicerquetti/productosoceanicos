...
<body>
    ...
    <div class="container mt-4">
        ...
        <button class="btn btn-success" onclick="window.location.href='nueva_compra_x.php';">Nueva Compra</button>
