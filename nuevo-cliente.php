...
// Si se envía el formulario, insertar el cliente en la base de datos
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO clientes (cliente, nombre, apellido, email, telefono, telefono2, direccion, localidad, provincia, dni, cuit, condicion_iva, razon_social, domicilio_fiscal, localidad_fiscal, provincia_fiscal, codigo_postal_fiscal, pagina_web, saldo_inicial, observaciones)
              VALUES ('$cliente', '$nombre', '$apellido', '$email', '$telefono', '$telefono2', '$direccion', '$localidad', '$provincia', '$dni', '$cuit', '$condicion_iva', '$razon_social', '$domicilio_fiscal', '$localidad_fiscal', '$provincia_fiscal', '$codigo_postal_fiscal', '$pagina_web', '$saldo_inicial', '$observaciones')";

    if ($conn->query($query) === TRUE) {
        $mensaje = "Cliente agregado exitosamente.";
    } else {
        $mensaje = "Error al agregar el cliente: " . $conn->error;
    }
}
?>
        ...
        <div class="form-container">
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="pagina_web" name="pagina_web" class="form-control">
                </div>

                <div class="mb-3">
                    <label for="saldo_inicial" class="form-label">Saldo Inicial</label>
                    <input type="number" id="saldo_inicial" name="saldo_inicial" class="form-control" step="0.01" value="0.00">
                </div>
